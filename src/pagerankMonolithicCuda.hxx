...
int pagerankMonolithicCudaLoop(T *e, T *r0, T *eD, T *r0D, T *&aD, T *&rD, T *cD, const T *fD, const size_t *vfromD, const int *efromD, int i, const J& ns, int N, T p, T E, int L, int EF) {
  int n = sumAbs(ns);
