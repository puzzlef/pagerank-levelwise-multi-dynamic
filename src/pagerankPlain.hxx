...
template <class T>
int pagerankPlainLoop(vector<T>& a, vector<T>& r, vector<T>& c, const vector<T>& f, const vector<size_t>& vfrom, const vector<int>& efrom, const vector<int>& vdata, int i, int n, int N, T p, T E, int L) {
  T c0 = (1-p)/N;
  int l = 1;
  for (; l<L; l++) {
